...
while True:
    ...
    if event == sg.WIN_CLOSED or event == 'Exit': 
      ...
      if (probability == 10 and (probability2 == 10 or probability2 == 7)) or ((probability == 8 or probability == 5) and probability2 ==10) and failState == 0:
        window['-Question-'].update(value="Você com certeza tem sensibilidade de pele!")
        ...
        window['-Question-'].update(value="Existem grandes chances de você ter sensibilidade de pele, porém, não detectamos nada na imagem",font = ("Arial Black",20))

      elif probability == 2 and probability2 ==10 and failState == 0:
        window['-Question-'].update(value="Existem grandes chances de você ter sensibilidade de pele, ou ter enviado uma imagem muito vermelha",font = ("Arial Black",20))

      elif (probability == 5 and probability2 ==3) or (probability == 2 and probability2 ==7) and failState == 0:
        window['-Question-'].update(value="Existe a possibilidade de você ter sensibilidade de pele, porém, parece que é outro sintoma que você tem, é recomendado passar eu um dermatologista para verificar",font = ("Arial Black",20))

      elif probability == 2 and probability2 ==3 and failState == 0:
        window['-Question-'].update(value="Provavelmente você não tem sensibilidade, caso esteja sentindo alguma coisa parecida recomendamos você a consultar um dermatologista",font = ("Arial Black",20))

      elif probability == 0 and failState == 1:
        window['-Question-'].update(value="Você respondeu o questionario todo com não, tirando qualquer possibilidade de ser sensibilidade, caso ainda esteja com problemas recomendamos você a consultar um dermatologista",font = ("Arial Black",20))

      elif probability2 == 0 and failState == 1:
        window['-Question-'].update(value="A imagem que você enviou não contem cor vermelha, caso acredite ter algo no rosto, responda o questionario novamente e envie uma nova foto assim como a recomendada!",font = ("Arial Black",20))
